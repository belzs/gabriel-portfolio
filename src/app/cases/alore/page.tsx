          ...
          return (
            ...
            >
              ...
              <div 
                ...
                className={`flex w-full max-w-full md:max-w-[870px] justify-center ${item.title === "PRODUCT" ? "bg-strong-gray" : "bg-white"} pb-8 md:pb-12 transition-all duration-1000 delay-300 ${
                  timelineSection.inView 
                    ? 'opacity-100 translate-x-0' 
                    : 'opacity-0 translate-x-8'
                }`}
